...
import blog4 from "../assets/images/blog/history-5.jpg";
...
export default class PageHistory extends Component {
    ...
    render() {
        return (
            <React.Fragment>
                <SectionTitle title="Наши особенности"/>
                                            ...
                                            <Card
                                                ...
                                                <CardBody>
                                                    <p className="mt-3 mb-0 text-muted">
                                                        Запускаем проекты строго по графику. Наша методика разработки
                                                        программных продуктов позволяет масштабировать беклог в любом
                                                        диапазоне.
                                                    </p>
                                                </CardBody>
                                            </Card>
                                    ...
                                    <Row>
                                        ...
                                        <Col lg={6} md={6} sm={6}>
                                            <Card
                                                ...
                                                <CardBody>
                                                    <p className="mt-3 mb-0 text-muted">
                                                        Мы заинтересованы в долгосрочном сотрудничестве, поэтому не
                                                        просто делаем работу, а помогаем нашему клиенту заработать!
                                                    </p>
                                                </CardBody>
                                            </Card>
                                        </Col>
